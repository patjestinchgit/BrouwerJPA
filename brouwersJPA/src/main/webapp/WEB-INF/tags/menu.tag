	...
	<ul>
		...
		<li><a href="#">Brouwers</a>
			<ul>
				...
				<li><a href="<c:url value='/brouwersopalfabet'/>">Brouwers op alfabet</a></li>
				<li><a href="<c:url value='/brouwersopnaam'/>">Brouwers op naam</a></li>
				<li><a href="<c:url value='/brouwersopnaam/brouwersopnaam'/>">Brouwers op naam</a></li>
			</ul></li>
