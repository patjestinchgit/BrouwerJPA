...
class BrouwersOpAlfabetController {
	...
	private static final String REDIRECT_URL_ALFABET_VIEW_STP1 = "redirect:/brouwersopalfabet";
	...
	ModelAndView brouwersopalfabetstp1Tostp2WithLetter(@PathVariable char letter) {
	...
	@RequestMapping(path="{letter}", method = RequestMethod.POST, params = "vorige")
	String brouwersopalfabetstp2Tostp1() { //@PathVariable char letter) {
				return REDIRECT_URL_ALFABET_VIEW_STP1;
	}
